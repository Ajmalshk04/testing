...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto rounded-md border border-border/40 bg-card/50 backdrop-blur-sm shadow-sm"
    >
      <table
        data-slot="table"
...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "[&_tr]:border-b [&_tr]:border-border/50 bg-muted/30 dark:bg-muted/20",
        className
      )}
      {...props}
    />
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "dark:hover:bg-muted/30 dark:data-[state=selected]:bg-muted/50",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "p-4 align-middle text-sm whitespace-nowrap",
